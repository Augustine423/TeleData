...
const RealTimeInfo = () => {
  ...
  useEffect(() => {
    const connectWebSocket = () => {
      ...
      ws.current = new WebSocket("ws://52.78.238.179:8080/telemetry");
      ...
      ws.current.onclose = () => {
        ...
        if (!reconnectInterval.current) {
          reconnectInterval.current = setInterval(connectWebSocket, 5000); // Reconnect every 5 seconds
        }
      };
    };
  ...
  return (
    <div className="w-full relative flex flex-col min-h-screen">
      ...
      <div className="w-full flex-1 relative">
        ...
        <MapContainer center={[35.0767, 129.0921]} zoom={13} style={{ height: "100vh", width: "100%" }}  className="z-0 w-full h-full" zoomControl={false}
                  trackResize={true}>
