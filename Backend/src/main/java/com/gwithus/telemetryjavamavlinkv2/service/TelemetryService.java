package com.gwithus.telemetryjavamavlinkv2.service;

import com.gwithus.telemetryjavamavlinkv2.websocketconfig.TelemetryWebSocketHandler;
...
public class TelemetryService {
    ...
    public void printAndSendTelemetry() {
        ...
        Map<Integer, Map<String, Object>> telemetryData = messageHandlerService.getTelemetryData();
    ...
    private void printTelemetryTable(Map<Integer, Map<String, Object>> telemetryData, Set<Integer> activePorts) {
